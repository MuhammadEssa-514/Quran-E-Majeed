...
export default function Navbar(props) {
  ...
  return (
    <>
      <nav className="absolute top-0 left-0 w-full z-10 bg-transparent md:flex-row md:flex-nowrap md:justify-start flex items-center p-2 hidden md:block bg-yellow-500">
